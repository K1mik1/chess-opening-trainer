const CACHE = 'opening-trainer-v8';
const ASSETS = ["./", "index.html", "style.css?v=8", "app.js?v=8", "coach.js?v=4", "public-puzzles.js?v=4", "puzzles-ui.js?v=6", "books.js?v=1", "repertoire.js", "pwa.js?v=4", "manifest.webmanifest", "pieces/bB.svg", "pieces/bK.svg", "pieces/bN.svg", "pieces/bP.svg", "pieces/bQ.svg", "pieces/bR.svg", "pieces/wB.svg", "pieces/wK.svg", "pieces/wN.svg", "pieces/wP.svg", "pieces/wQ.svg", "pieces/wR.svg", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
